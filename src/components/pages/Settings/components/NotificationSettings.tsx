        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b">
                    ...
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notificationSettings.emailNotifications
                                    ? 'translate-x-6'
                                    : 'translate-x-1'
                                }`}
                        />
                ...
                <div className="flex items-center justify-between py-3 border-b">
                    ...
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notificationSettings.pushNotifications
                                    ? 'translate-x-6'
                                    : 'translate-x-1'
                                }`}
                        />
                ...
                <div className="flex items-center justify-between py-3">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notificationSettings.weeklyReports ? 'bg-blue-600' : 'bg-gray-200'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notificationSettings.weeklyReports
                                    ? 'translate-x-6'
                                    : 'translate-x-1'
                                }`}
                        />
            ...
            <button
                onClick={() => toast.info('Notification settings saved (UI only)')}
